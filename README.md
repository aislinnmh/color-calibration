...
- Orient image(s) such that target appears horizontal (5 squares high by 6 wide) withe the dark brown square in the top right corner. Small angles are fine.
...
- Select Custom fromt eh RGB Transform Light Source list
- Select a gain (e.g. Gain 00) from the Color Transformation Value Selector list and enter the CCM value in Color Transformation Value 
- Repeat the above for all 9 Gain values in the format below:
...
- Save the new CCM to the User Set 0 in SpinView.
